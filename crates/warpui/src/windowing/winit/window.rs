...
/// to work around it. See: https://github.com/warpdotdev/Zap/issues/6120
fn enable_decorations_if_needed(window: &winit::window::Window, adapter_info: &AdapterInfo) {
    if adapter_has_rendering_offset_bug(adapter_info) {
        log::warn!(
            ...
            selected GPU adapter ({}). See: https://github.com/warpdotdev/Zap/issues/6120",
            adapter_info.name,
        );
...
fn create_window(
    ...
    #[cfg(windows)]
    {
        ...
        // https://github.com/warpdotdev/Zap/issues/8935
